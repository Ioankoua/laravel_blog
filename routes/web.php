...
Route::group(['namespace' => 'Personal', 'prefix' => 'personal', 'middleware' => ['auth', 'verified']], function() {
    ...
    Route::group(['namespace' => 'Comment'], function () {
        ...
        Route::get('/comment/{comment}/edit', 'EditController')->name('personal.comment.edit');
        Route::patch('/comment/{comment}', 'UpdateController')->name('personal.comment.update');
        Route::delete('/comment/{comment}', 'DeleteController')->name('personal.comment.delete');
    });
});
