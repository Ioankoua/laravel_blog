        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach($post->tags as $tag)
                    <div class="btn btn-sl btn-primary"><i class="nav-icon fas fa-tag"> {{ $tag['title'] }}</i></div>
                @endforeach
                </div>
                <div class="col-1">
                @auth()
                ...
                <div class="col-lg-9 mx-auto">
                    ...
                    <section>
                        ...
                        @foreach($post->comments as $comment)
                            <div class="comment-text mb-4" style="background-color: lightskyblue; padding: 20px;">
                                <span class="username">
                                    <div>
